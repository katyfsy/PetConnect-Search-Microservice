...
INSERT INTO pets(id, owner, name, type, zip, age, sex, breed, weight, reproductive_status, description, cover_photo, favorite_count, reported, adopted, score)
...
INSERT INTO pets(id, owner, name, type, zip, age, sex, breed, weight, reproductive_status, description, cover_photo, favorite_count, reported, adopted, score)
VALUES (DEFAULT, 'Owner', 'Ashley', 'guinea pig', '64328', 'young', 'female', 'abyssinian', 0.5, true, 'furry critter', 'https://static.inaturalist.org/photos/95742200/large.jpeg', 0, false, false, 0);
